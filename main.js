(function($) {
  ...
  var productSlider = new Swiper('.product-sidebar-slider-blog', {
    autoplay: false,
    slidesPerView : 1,
    spaceBetween: 26,
    loop: true,
...
$('.single-group-prod input').on('click', function(){
  var name = $(this).attr('rel');
  if ($(this).is(':checked')){
      $( "label[data-pd='" + name +"']" ).addClass('selected');
  } else{
      $( "label[data-pd='" + name +"']" ).removeClass('selected');
  }
});
  ...
  // Product Bundle Slider Js
  var productSlider = new Swiper('.product-bundle-slider', {
    autoplay: false,
    slidesPerView : 3,
    spaceBetween: 20,
    loop: false,
  ...
  var productSlider = new Swiper('.product-brands-slider', {
    autoplay: false,
    slidesPerView : 'auto',
    spaceBetween: 20,
    loop: true,
